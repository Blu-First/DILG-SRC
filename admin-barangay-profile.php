...
$barangay_id = $_GET['barangay'];

$query = mysqli_query($db, "SELECT * from users WHERE user_id = '$barangay_id'");
...
?>
    ...
    <head>
        ...
        <title>Barangay <?php echo $row['name']; ?> - Profile </title>
                    ...
                    <div class="card-box pd-30 height-100-p mb-30">
                        <div class="row align-items-center custom-row mr-5 ml-5">
                            ...
                            <div class="col-md-6 pl-20">
                                ...
                                <div class="mt-2">
                                    <a class="dilg-button" href="inbox.html" hreflang="en" type="text/html">Message</a>
                                </div>
                                </p>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="brgy-info-container">
                                    <ul>
                                        <li>
                                            <i class="bx bx-phone pr-1 color-darkpink"></i>
                                            <?php
                                            $phoneNo = $row['phone_no'];

                                            if (!empty($phoneNo)) {
                                                echo '<a href="tel:' . $phoneNo . '">' . $phoneNo . '</a>';
                                            } else {
                                        ...
                                        <li>
                                            <i class="bx bx-envelope pr-1 color-darkpink"></i>
                                            <?php
                                            $email = $row['email'];
                                        ...
                                        <li>
                                            <i class="bx bx-map-pin pr-1 color-darkpink"></i>
                ...
                <div class="pl-3">
                    <ul class="nav ml-2" id="doc-tab-list" role="tablist">
                        <li class="nav-item secondary-nav" role="navigation">
                            <a class="nav-link active px-0 pb-0 ml-4 mb-10" id="submission-tab" data-target="submission" data-tab="submission" href="#submission" role="tab" aria-controls="Submission" aria-selected="true">Submissions</a>
                        </li>
                        <li class="nav-item secondary-nav" role="navigation">
                            <a class="nav-link secondary-nav px-0 pb-0 ml-4 mb-10" id="all_files-tab" data-target="all_files" data-tab="all_files" href="#all_files" role="tab" aria-controls="All Files" aria-selected="false">All Files</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="doc-tab-content">
                                        ...
                                        <table id="submittedTbl" class="data-table table hover nowrap mb-5">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_POST['search-submittedTbl']) && !empty(trim($_POST['search-submittedTbl']))) {
                                                    ...
                                                    $sql = "SELECT doc_name, govarea, status, DATE_FORMAT(time_submitted, '%m/%d/%Y') AS f_date FROM mov WHERE user_id = $barangay_id";
                                                }
                        ...
                        <!-- All Files Tab -->
                        <div class="tab-pane fade" id="all_files" role="tabpanel" role="tabpanel" aria-labelledby="all_files-tab">
                            <!-- Page Title -->
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        ...
                                                                        <a href="admin-financial-ad-sustain.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Financial Administration and
                                                                            Sustainability</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        <img src="vendors/images/icon-folder.png">
                                                                        <a href="admin-disaster-prep.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Disaster
                                                                            Preparedness</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        <img src="vendors/images/icon-folder.png">
                                                                        <a href="admin-safety-peace-order.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Safety, Peace and Order</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        <img src="vendors/images/icon-folder.png">
                                                                        <a href="admin-social-protect-sensitivity.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Social Protection and
                                                                            Sensitivity</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        <img src="vendors/images/icon-folder.png">
                                                                        <a href="admin-business.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Business-Friendliness and
                                                                            Competitiveness</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="pl-30">
                                                                        <img src="vendors/images/icon-folder.png">
                                                                        <a href="admin-environmental-manage.php?barangay=<?php echo $barangay_id; ?>" class="pl-10">Environmental Management</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function handleTabClick(event) {
                    ...
                    history.pushState(null, null, 'admin-barangay-profile.php?barangay=<?php echo $barangay_id; ?>&tab=' + tabId);
                ...
                function initTab(tabQuery) {
                    let tabContents = document.querySelectorAll('.tab-pane');
                    let selectedTabContent = document.getElementById(tabQuery);
                    let tabLinks = document.querySelectorAll('.nav-link');
                    let navLink = document.getElementById(`${tabQuery}-tab`);
                ...
                // Call the function with different tabQuery values
                const urlQuery = new URLSearchParams(window.location.search);
                const tabQuery = urlQuery.get('tab');


                if (tabQuery === 'all_files') {
                    initTab('all_files');
                } else if (tabQuery === 'submission') {
                    initTab('submission');
                }
