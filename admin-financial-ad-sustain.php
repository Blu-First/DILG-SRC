                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-11">
                            <p class="font-12 directory">
                                <a href="admin-barangay-profile.php?barangay=<?php echo $barangay_id; ?>&tab=all_files">
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    ...
                                    <div class="row pb-4">
                                        ...
                                        <table class="table hover nowrap mb-0">
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($db, "SELECT doc_id, doc_name from mov WHERE user_id = $barangay_id AND govarea = 'Financial Administration and Sustainability'");
