...
<body>
	...
	<div class="dilg-header px-5">
		...
		<div class="dilg-header-left col-2 col-sm-3">
		...
		<div class="dilg-header-right">
			...
			<div class="sub-btn-container pr-30">
				<a  id="user-sub-btn" class="submission-btn" href="#" hreflang="en" type="text/html">Submissions</a>
			</div>

			<!-- Notifications Button -->
			<a class="nav-icon mx-3 d-none d-sm-inline" href="#">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-bell-fill"
					viewBox="0 0 16 16">
					<path
			...
			<!-- Inbox Button -->
			<a class="nav-icon mx-3 d-none d-sm-inline" href="#">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-inbox"
					viewBox="0 0 16 16">
					<path
			...
			<!-- User Icon -->
			<a class="nav-icon mx-3 d-none d-sm-inline" href="#">
				<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-person-circle"
					viewBox="0 0 16 16">
    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
						...
						<div class="align-items-center">
							<nav class="align-items-center" style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
								<ol class="breadcrumb pl-4">
								  ...
								  <li class="breadcrumb-item active" ><a href="#"></a>Submission Progress</a></li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="col-12 mb-20">
					<div class="card-box  py-4 px-3 mx-3">
						<div class="d-inline-block px-4">
							<h6 class="text-uppercase color-darkpink">Archive</h6>
						</div>
						<div class="d-flex align-items-center px-4">
							<div class="flex-shrink-0 ">
								<h2 class="weight-600">Document History</h2>
							</div>
							<div class="accent-h-line flex-grow-1 ml-4">
			...
			<!-- Timeline Selector -->
            <div class="d-flex pb-10 mb-20 pr-3 align-items-start">
				<div class="card-box timeline d-inline-block flex-shrink-0 py-3  mx-3">
					<div class="d-flex flex-column align-items-center py-3">
						<div class="timeline h4 weight-700">Timeline</div>
						<a href="#" >
							<div class="h6 section-nav d-flex align-items-center ">
								<div class="mr-3">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path d="M21 4H3C2.73478 4 2.48043 4.10536 2.29289 4.29289C2.10536 4.48043 2 4.73478 2 5V19C2 19.2652 2.10536 19.5196 2.29289 19.7071C2.48043 19.8946 2.73478 20 3 20H21C21.2652 20 21.5196 19.8946 21.7071 19.7071C21.8946 19.5196 22 19.2652 22 19V5C22 4.73478 21.8946 4.48043 21.7071 4.29289C21.5196 4.10536 21.2652 4 21 4ZM20 15C19.2044 15 18.4413 15.3161 17.8787 15.8787C17.3161 16.4413 17 17.2044 17 18H7C7 17.2044 6.68393 16.4413 6.12132 15.8787C5.55871 15.3161 4.79565 15 4 15V9C4.79565 9 5.55871 8.68393 6.12132 8.12132C6.68393 7.55871 7 6.79565 7 6H17C17 6.79565 17.3161 7.55871 17.8787 8.12132C18.4413 8.68393 19.2044 9 20 9V15Z" fill="currentColor"/>
										<path d="M12 8C9.794 8 8 9.794 8 12C8 14.206 9.794 16 12 16C14.206 16 16 14.206 16 12C16 9.794 14.206 8 12 8ZM12 14C10.897 14 10 13.103 10 12C10 10.897 10.897 10 12 10C13.103 10 14 10.897 14 12C14 13.103 13.103 14 12 14Z" fill="black"/>
										</svg>									
								</div>
								2019
							</div>
				...
				<div class="card-box d-inline-block w-100 py-4 px-5 ">
					<div class="pb-20">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
							<div class="d-flex align-items-center py-3 pl-3 pr-0">
								<div class="h4 flex-shrink-0"><span class="color-darkpink">2023</span> SGLGB Documents
								</div>
										...
										<thead>
											<tr>
												...
												<th><img class=" pr-1" src="vendors/images/icon-link.svg"
														alt="">Attachment</th>
												<th><img class="mb-1 pr-1" src="vendors/images/icon-date.svg" alt="">Date
												</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>
													<a href="#"><u>AttachmentForm.pdf</u></a>
												</td>
